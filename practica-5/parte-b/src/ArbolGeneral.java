public class ArbolGeneral<T> {
  ...
  public void enOrden() {
    if (!(this.esVacio())) {
      ...
      System.out.println(this.getDato().toString());
    }
  ...
  public ListaGenericaEnlazada<T> preOrden() {
    ...
    preOrdenRecursivo(resultado);
    return resultado;
  }

  private void preOrdenRecursivo(ListaGenericaEnlazada<T> lista) {
